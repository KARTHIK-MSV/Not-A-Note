...
// // Set the default code when the page loads
...
//   // Send code to the API for execution
//   executeCode(language, code)
//     .then((result) => {
//       // Check if result is valid and has output
...
// // Function to call the API and execute the code
...
// let selectedColor = '#FFA07A'; // Default color for notes

// // Load folders from local storage or initialize empty object
// let folders = JSON.parse(localStorage.getItem('folders')) || {};

// // Function to save folders and notes to local storage
...
//     menuBtn.style.display = 'none'; // Hide the button when panel is open
// });

// // Close the sliding panel
// closeBtn.addEventListener('click', function() {
//     slidingPanel.classList.remove('active');
//     menuBtn.style.display = 'block'; // Show the button when panel is closed
// });
...
// // Function to open a folder and display notes
...
//         // If a note is currently being edited, update its color
